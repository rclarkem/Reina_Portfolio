			...
			c = {
						...
						s.$control.animate(
							...
							function() {
								s.size() > 1 &&
									...
									i.outgoing_slide >= 0 &&
										n.eq(i.outgoing_slide).css({ left: s.width, display: 'none', zIndex: 0 })),
									t()
							},
						)
				},
				fade: function(i, t) {
					...
					o
						...
						.animate({ opacity: 1 }, n.options.animation_speed, n.options.animation_easing),
						i.outgoing_slide >= 0
							? s.animate({ opacity: 0 }, n.options.animation_speed, n.options.animation_easing, function() {
									n.size() > 1 &&
										(e.eq(i.upcoming_slide).css({ zIndex: 2 }),
										i.outgoing_slide >= 0 &&
											e.eq(i.outgoing_slide).css({ opacity: 1, display: 'none', zIndex: 0 })),
										t()
							  })
							: (o.css({ zIndex: 2 }), t())
				},
					...
					e.$el.trigger('animating.slides', [s]),
						e.animation(s, function() {
							e._findPositions(s.upcoming_slide, e),
								...
								e.init || (e.$el.trigger('init.slides'), (e.init = !0), e.$container.fadeIn('fast'))
						})
				}
			},
		}),
			...
			return (
				this.each(function() {
					...
					return (
						...
						'string' == typeof i && ((o = r[i]), 'function' == typeof o) ? (o = o.call(r, s)) : void 0
					)
				}),
				o
			)
